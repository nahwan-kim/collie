...
// square and rounded corners, and the TEES an inner separator row hangs off — light, heavy and double
// in each. Never a horizontal rule glyph: this alphabet answers "is this row framed?", not "is this
// row a rule".
